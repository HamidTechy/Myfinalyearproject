...
?>
	...
	?><img src="images/previous.png" alt="" width="32" height="32" /></td>
        <td colspan="2"><a href="studentins.php" onClick="openstudent(); return false"><img src="images/add.png" alt="" width="32" height="32" /></a></td>
          <?php 
$first=$_GET["first"]+10;
$last = $_GET["last"]+ 10;
?>
...
<?php
	...
	{
		?>
     <p><a href="examview.php?first=<?php echo $first; ?>&amp;last=<?php echo $last; ?>"><a href="studentins.php" onClick="openstudent(); return false"><strong>Add Students</strong></a></p>
 <?php
	}
	?>
  </section>
