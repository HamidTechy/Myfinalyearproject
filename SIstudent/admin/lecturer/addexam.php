...
$totcourse = mysqli_query($con,"SELECT * FROM examination");
...
{
$sql="INSERT INTO attendance (examid, studid, subid, courseid, internaltype, maxmarks, scored, percentage, result, comment)
VALUES
('$_POST[examid]','$_POST[studid]','$_POST[subid]','$_POST[courseid]','$_POST[internaltype]','$_POST[maxmarks]','$_POST[scored]','$_POST[percentage]','$_POST[result]','$_POST[comment]')";
 ...
 while($row1 = mysqli_fetch_array($reslec))
  ...
  <tr><td><p>
    <label for="textfield2">Cource :</label></p></td>
       <td><p><select name="courseid" value="<?php echo $subid; ?>">
     <option value="">Cource Id</option>
     <?php
  ...
  echo "<option value='$row1[courseid]' ". $selvar . ">$row1[courseid]</option>";
  $selvar ="";
  }
  ?>
    </select></tr>
   <tr><td><p>
    <label for="textfield2">Internal Type :</label></p></td>
    <td><p><input type="text" name="internaltype" id="textfield2"  >
  </p></td></tr>
  <tr><td><p>
    <label for="textfield2">Maximum Marks :</label></p></td>
    <td><p><input type="text" name="maxmarks" id="textfield2"  >
  </p></td></tr>
  <tr><td><p>
  
  <tr><td><p>
    <label for="textfield2">Scored Marks :</label></p></td>
    <td><p><input type="text" name="scored" id="textfield2"  >
  </p></td></tr>
  <tr><td><p>
  ...
  <tr><td><p>
    <label for="textfield2">Result :</label></p></td>
    <td><p><input type="text" name="result" id="textfield2"  >
  </p></td></tr>
  <tr><td><p>
